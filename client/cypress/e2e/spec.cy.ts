describe('homepage', () => {
  ...
  //   cy.get('#email').type('test1@mail.com'); // change before test
  ...
  //   cy.contains('Log In');
  //   cy.get('#email-input').type('test1@mail.com');
  ...
  //   cy.get('[name="email"]').type('bilbobaggins@theshire.com');
  ...
  //   cy.contains('Log In');
  //   cy.get('#email-input').type('bilbobaggins@theshire.com');
