...
const LandingAbout = () => {
  return (
    <div className="about-page bg-[#a8b4b4]" id="about">
      <div className="container">
        <div className='flex flex-col items-center'>
          <div className="text-left ml-8">
            <h1 className="mb-2  text-3xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-4xl dark:text-white">
              About
            </h1>
          </div>
          <p
            className="about-text mb-6 font-light text-grey-500 lg:mb-8 md:text-lg lg:text-xl dark:text-gray-400"
          ...
          <img className='cursor-default drop-shadow-2xl rounded-lg w-96 mt-8 mb-6' src="https://media.istockphoto.com/id/869301564/photo/splitting-it-six-ways.jpg?s=612x612&w=0&k=20&c=i_rAQ1-4iyooawtB2bYKsrOMIRAzzrYpLzLmx0LNniQ=" alt="friends splitting the bill" />
        </div>
      </div>
    </div>
  );
