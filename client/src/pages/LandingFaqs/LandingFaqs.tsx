      ...
      <div className='faqs-page mr-auto place-self-start lg:col-span-7' id='faqs'>
        <div>
          ...
          <details className='faq'>
            <summary className=' mb-6 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl dark:text-gray-400'>How do I create a new event?</summary>
          ...
          <details className='faq'>
            <summary className=' mb-6 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl dark:text-gray-400'>How can I invite participants to my event?</summary>
            <p className='faq-answer'>
          ...
          <details className='faq'>
            <summary className=' mb-6 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl dark:text-gray-400'>How do I manage RSVPs for my event?</summary>
            <p className='faq-answer'>
          ...
          <details className='faq'>
            <summary className=' mb-6 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl dark:text-gray-400'>Can I split bills among event attendees?</summary>
            <p className='faq-answer'>
          ...
          <details className='faq'>
            <summary className=' mb-6 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl dark:text-gray-400'>How do I create a to-do list for my event?</summary>
            <p className='faq-answer'>
          ...
          <details className='faq'>
            <summary className=' mb-6 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl dark:text-gray-400'>Can I join existing events organized by others?</summary>
            <p className='faq-answer'>
          ...
          <details className='faq'>
            <summary className=' mb-6 font-light text-gray-500 lg:mb-4 md:text-lg lg:text-xl dark:text-gray-400'>How can I stay connected with event participants?</summary>
            <p className='faq-answer'>
